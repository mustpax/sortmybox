...
public class DatastoreUtilTest extends BaseModelTest {
    ...
    public void testCountOverDateRange() {
        ...
        DailyUsageStats s1 = new DailyUsageStats(3L, 2L, 1L, d1);
        DailyUsageStats s2 = new DailyUsageStats(3L, 2L, 1L, d2);
        DailyUsageStats s3 = new DailyUsageStats(3L, 2L, 1L, d3);
